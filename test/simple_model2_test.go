...
// ref: https://pgaleone.eu/tensorflow/go/2017/05/29/understanding-tensorflow-using-go/
...
func TestSimpleModel2(t *testing.T) {
	runSimpleModel()
}

func Benchmark_SimpleModel2(b *testing.B) {
	n := b.N
	for i := 0; i < n; i++ {
		runSimpleModel()
	}
